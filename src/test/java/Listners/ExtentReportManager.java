...
public class ExtentReportManager implements ITestListener{
	...
	public void onStart(ITestContext testContext) 
	{
		...
		sparkreporter= new ExtentSparkReporter(".//ExtentReports/reports/"+repName);  //specify location of the report
		...
		extent.setSystemInfo("Application", "Quality Improvement App | Health and Social Care | Tendable");
